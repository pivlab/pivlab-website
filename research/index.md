...
{% include citation.html lookup="pubmed:39977605" style="rich" %}
...
{% include list.html data="citations" component="citation" style="rich" filter="authors != '' and title =~ /^(?!$)(?i)(?!author correction)/" %}
